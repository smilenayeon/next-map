    ...
    <form className="px-4 md:max-w-4xl mx-auto py-8" onSubmit={handleSubmit(async(data) => {
      ...
      <div className="space-y-12">
        ...
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base font-semibold leading-7 text-gray-900">Edit Restaurant Info</h2>
          <p className="mt-1 text-sm leading-6 text-gray-600">Fill out the form to edit the restaurant info.</p>
